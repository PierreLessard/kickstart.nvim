...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      -- Personal note: removed format on save because autosave is often enabled
  ...
  { -- You can easily change to a different colorscheme.
    ...
    priority = 1000,
    config = function()
      -- Set the palette before loading the colorscheme
      vim.g.gruvbox_material_background = 'material' -- options: 'material', 'mix', 'original'
